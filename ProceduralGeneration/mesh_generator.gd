...
func create_plane(subdiv: int, index: int, dir: Vector3, center: Vector3) -> Array:
	...
	dir = dir.normalized()
	var binormal := Vector3(dir.z, dir.x, dir.y) / subdiv
	var tangent := binormal.rotated(dir, PI / 2.0)
